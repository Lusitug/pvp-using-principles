...
public class Batalha {
    ...
    public IArma fabricarArma(){
        ...
        arma = switch (armaInt) {
            case 1->  ArmaIncialFactory.getInstance().criaArma(ETipoArma.ESPADACURTA);
            case 2-> ArmaIncialFactory.getInstance().criaArma(ETipoArma.ARCOCURTO);
            case 3-> ArmaIncialFactory.getInstance().criaArma(ETipoArma.VARINHA);
            case 4-> ArmaIncialFactory.getInstance().criaArma(ETipoArma.CETRODEMADEIRA);
    ...
    public void batalhar(Jogador jogador1, Jogador jogador2) {
        ...
        while (jogador1.getHP() > 0 && jogador2.getHP() > 0) {
            ...
            int dano1 =  Math.max(0, jogador1.atacar() - jogador2.getDefesa()); 
            ...
            int dano2 =  Math.max(0, jogador2.atacar() - jogador1.getDefesa()); 
